...
public class DefaultStackTraceCleaner implements StackTraceCleaner {
    ...
    private static boolean isMockDispatcher(String className) {
        return className.startsWith("org.mockito.internal.creation.bytebuddy.MockMethodAdvice$MockDispatcher")
        || className.startsWith(
        "org.mockito.internal.creation.bytebuddy.MockMethodAdvice$DispatcherDecorator");
    }
    ...
    private static boolean isFromMockitoRule(String className) {
        return className.startsWith("org.mockito.internal.")
        || className.startsWith("org.mockito.exceptions.")
        || className.startsWith("org.mockito.junit.")
        || className.startsWith("org.mockito.verification.")
        || className.startsWith("org.mockito.configuration.");
    }
